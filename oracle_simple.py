...
import connect_db as cn  #module in RECURRING_RESOURCES
...
##SQL Output csv ###################################################
##Connects to ORACLE with ODBC connection and pulls output data into pandas dataframe
...
def main():
    ...
    #input_config = 'U:/UWHealth/EA/SpecialShares/DM/CRDS/AdHocQueries/Report_Automation/SAMPLE_RITMS/AUTO_TEST_02_ORACLE/automation_scripts_config_be_careful/AUTO_TEST_02_ORACLE.cfg'
    ...
    ##Execute Query and save it as a csv file
