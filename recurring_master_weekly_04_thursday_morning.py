...
def main():
    ...
    try:        
        ...
        #report_list_path = sys.argv[1]
        report_list_path = 'U:/UWHealth/EA/SpecialShares/DM/CRDS/AdHocQueries/Requests_DATA/recurring_requests/RECURRING_RESOURCES/live_reporting_scripts/RECURRING_WEEKLY_THURSDAY_MORNING.csv'
        
        ritm_config_dict = report_list(report_list_path)    #Get list of reports in csv file
        
        dt_format = '%Y-%m-%d'
        #job_name = sys.argv[2]
        job_name = 'RECURRING_WEEKLY_THURSDAY_MORNING'
        
        #daily_log_file_path = sys.argv[3]
        daily_log_file_path = 'U:/UWHealth/EA/SpecialShares/DM/CRDS/AdHocQueries/Requests_DATA/recurring_requests/RECURRING_RESOURCES/live_reporting_scripts/logs/RECURRING_WEEKLY_THURSDAY_MORNING_LOG.txt'
